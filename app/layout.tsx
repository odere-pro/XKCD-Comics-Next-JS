...
export const metadata: Metadata = {
    title: 'XKCD Webcomic',
    description: 'This is a simple UI to explore XKCD strips - https://xkcd.com. It is built using Next.js and TypeScript.',
}
            ...
            <body className={clsx(inter.className, 'flex min-h-screen flex-col items-center')}>
                <header className="content-bg w-full max-w-5xl px-4 md:px-8 lg:px-16">
                    <div className="flex items-center justify-between border-b border-gray-400 py-4">
                        <BreadCrumbs />
                        <h1>XKCD - A webcomic of romance, sarcasm, math, and language.</h1>
                    </div>
                </header>
